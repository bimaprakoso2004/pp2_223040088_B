...
public class HelloGridBagLayout extends JFrame {
    ...
    public HelloGridBagLayout() {
        ...
        JPanel controlPanel = new JPanel(); // Perbaikan nama kelas
        controlPanel.setLayout(new FlowLayout());

        JPanel panel = new JPanel(); // Mengganti tanda '-' dengan '='
        ...
        gbc.gridx = 0;
        gbc.gridy = 0; // Mengganti tanda '-' dengan '='
        ...
        this.setVisible(true); // Tambahkan ini agar frame terlihat
    }
