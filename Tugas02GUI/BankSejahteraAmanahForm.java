...
public class BankSejahteraAmanahForm extends JFrame {
	    ...
	    public BankSejahteraAmanahForm() {
	        ...
	        gbc.gridx = 0;
	        gbc.gridy = 5;
	        String[] jenisTabungan = {"Tabungan Bersama", "Tabungan Plus", "Tabungan Siswa", "Tabungan Masa Tua"};
